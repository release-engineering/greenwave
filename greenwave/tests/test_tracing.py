...
JSON_MESSAGE = {
    "data": {
        "brew_task_id": ["57212843"],
        "ci_docs": ["https://docs.example.com/ci"],
        "ci_email": ["example@email.com"],
        "ci_name": ["Container Test"],
        "ci_team": ["Test"],
        "ci_url": ["https://docs.example.com/ci"],
        "full_names": ["https://docs.example.com/ci"],
        "id": [
            "sha256:a7fc01280c6b8173611c75a2cbd5a19f5d2ce42d9578d4efcc944e4bc80b09a0"
        ],
        "issuer": ["Test"],
        "item": ["avahi"],
        "log": ["https://docs.example.com/ci"],
        "msg_id": ["ID:jenkins-2-8dcwr-46389-1700226798425-136563:1:1:1:1"],
        "scratch": ["false"],
        "system_architecture": ["x86_64"],
        "system_provider": ["Test"],
        "type": ["redhat-module"],
    },
    "groups": [],
...
def test_tracing(mocked_factory, mocked_decision, mocked_decision_unchanged):
    ...
    with patch.object(resultdb_class, "connection", side_effect=mock_connection):
        ...
        assert (
            mock_publish.call_args.args[0]["traceparent"] == JSON_MESSAGE["traceparent"]
        )
...
def test_init_tracing_with_valid_config(
    mock_resource, mock_batch, mock_instrumentor, mock_span_exporter, mock_provider
):
    app = MagicMock()
    ...
    (
        mock_instrumentor().instrument_app.assert_called_once_with(
            app, tracer_provider=mock_provider.return_value
        )
    )
