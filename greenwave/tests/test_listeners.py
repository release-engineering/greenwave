...
class TestListenerAnnouncementSubject:
    ...
    def test_announcement_keys_decode_with_list(self):
        message = {
            "data": {
                "original_spec_nvr": ["glibc-1.0-1.fc27"],
            }
        }
        assert self.announcement_subject(message) == {
            "type": "koji_build",
    ...
    def test_no_announcement_subjects_for_empty_nvr(self):
        ...
        assert self.announcement_subject(message) is None

    def test_announcement_subjects_for_brew_build(self):
